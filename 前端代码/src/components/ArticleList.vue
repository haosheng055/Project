  ...
  <div>
    <div id="main"
      >
        <div
        :key="index"
        v-for="(blog,index) in Articles11.Titles" style="width:85%">
        ...
        @click="toArticle(Articles11.WriterIDs[index],Articles11.AIDs[index])">
            ...
            <div id="like and comment">
                <i class="fa fa-thumbs-o-up" aria-hidden="true"></i><i style="font-weight:0">{{Articles11.Likes[index]}}&emsp;</i>
                <i class="fa fa-comment-o"></i><i style="font-weight:0">{{Articles11.NumComments[index]}}</i>
            </div>
            </div>
        </div>
    </div>
